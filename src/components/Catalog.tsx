...
const categories = [
  ...
  },
  {
    ...
    gradient: "from-teal-500/20 to-teal-900/40",
    manager: { name: "Анастасия Громова", phone: "+7 (495) 123-45-13", email: "gromova@pioneer-trade.ru" },
    products: [
      "L-Глицин (Gly)", "L-Аланин (Ala)", "L-Валин (Val)",
      "L-Лейцин (Leu)", "L-Изолейцин (Ile)", "L-Пролин (Pro)",
      "L-Фенилаланин (Phe)", "L-Триптофан (Trp)", "L-Метионин (Met)",
      "L-Серин (Ser)", "L-Треонин (Thr)", "L-Цистеин (Cys)",
      "L-Тирозин (Tyr)", "L-Аспарагин (Asn)", "L-Глутамин (Gln)",
      "L-Аспарагиновая кислота (Asp)", "L-Глутаминовая кислота (Glu)",
      "L-Лизин (Lys)", "L-Аргинин (Arg)", "L-Гистидин (His)",
      "DL-Метионин (кормовой)", "L-Треонин (кормовой)", "L-Лизин HCl (кормовой)",
      "L-Триптофан (кормовой)", "L-Валин (кормовой)",
      "Таурин", "L-Карнитин", "L-Орнитин",
      "L-Цитруллин", "L-Гидроксипролин", "Бетаин (триметилглицин)",
      "N-Ацетил-L-цистеин (NAC)", "N-Ацетил-L-тирозин", "L-Теанин",
    ],
  },
];
